"""
Модуль конфигурации для работы с OpenAI API.
Содержит настройки подключения, параметры запросов,
функции для создания клиента OpenAI и обработки системных промптов.
"""
