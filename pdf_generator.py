"""
Модуль для создания PDF-отчетов с текстом и визуализациями.
Отвечает за извлечение Python-кода для диаграмм из ответов GPT,
генерацию графиков с помощью matplotlib, создание PDF-документов
и объединение нескольких PDF-файлов в один итоговый отчет.
"""
import os
import re
import matplotlib
